...
for VERSION in ${PHP_VERSIONS}; do
    ...
    docker build distroless --build-context common=. --tag="phpexperts/php:${VERSION}-full"           --build-arg PHP_VERSION=$VERSION --build-arg BASE_IMAGE="phpexperts/php-ubuntu:${VERSION}-full" --no-cache --progress=plain
