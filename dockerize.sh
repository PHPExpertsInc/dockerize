...
if [ ! -f ./vendor/bin/composer ]; then
    ...
    curl https://raw.githubusercontent.com/PHPExpertsInc/dockerize/master/bin/composer -o vendor/bin/php
    echo "Downloading phpexperts/dockerize's composer CLI launcher..."
    curl https://raw.githubusercontent.com/PHPExpertsInc/dockerize/master/bin/php -o vendor/bin/composer
